...
function Footer(){
    ...
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-2 md:mb-0">
              <a href="{{< param homepage >}}/" className="flex items-center">
                  <img src={logo} className="h-8 me-3" alt="neon soft" />
                  <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">neon soft</span>
              </a>
          </div>
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  ...
                  <ul className="text-gray-500 dark:text-gray-400 font-medium">
                      <li className="mb-2">
                          <a href="{{< param homepage >}}/" className="hover:underline">neon soft</a>
                      </li>
                      <li>
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="{{< param homepage >}}/" className="hover:underline">noen soft</a>. All Rights Reserved.
          </span>
